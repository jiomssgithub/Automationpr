...
public class ApacheExcelDataRead {

	public void ReadDataForGivenRowAndCol(int rowno, int colno) throws IOException
	{
    ...
    int d=s.nextInt();
    ApacheExcelDataRead ad=new ApacheExcelDataRead();
    ad.ReadDataForGivenRowAndCol(c,d);
	}
